...
export type TravelEvent<T extends TypeNames<typeof TravelEvent> = undefined> = VariantOf<
    typeof TravelEvent,
    T
>;
 ...
 * General events
 */
export const RelicOutcome = catalog(['pass', 'buy', 'haggle']);
export type RelicOutcome = keyof typeof RelicOutcome;

export const FoundMoneyOutcome = catalog(['keep', 'return', 'turnIn', 'ignore']);
export type FoundMoneyOutcome = keyof typeof FoundMoneyOutcome;

export const DrowningOutcome = catalog(['help', 'save', 'drown', 'ignore']);
export type DrowningOutcome = keyof typeof DrowningOutcome;

export const MuggingOutcome = catalog(['victory', 'paid', 'injured', 'died', 'saved']);
export type MuggingOutcome = keyof typeof MuggingOutcome;

export const LoveOutcome = catalog(['taken', 'reject', 'mutual']);
...
export const ArrivalOutcome = catalog(['success', 'late', 'bankrupt']);
export type ArrivalOutcome = keyof typeof ArrivalOutcome;

export const ForkOutcome = catalog(['wrong', 'correct', 'wait']);
...
export const ProstituteOutcome = catalog(['chat', 'baby', 'std']);
export type ProstituteOutcome = keyof typeof ProstituteOutcome;

export const FightOutcome = catalog(['join', 'authority', 'watch']);
...
export const BreakupOutcome = catalog(['violent', 'unpleasant', 'amicable', 'sad']);
